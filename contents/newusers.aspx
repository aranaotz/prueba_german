<%@ Page Title="" Language="VB" MasterPageFile="../logins/logins.master" AutoEventWireup="false" CodeFile="newusers.aspx.vb" Inherits="newusers" %>
                            ...
                            <div class="centrado">
                                ...
                                <div style="text-align:center;">
                                    <table class="centrado">
                                       ...
                                       <tr>
                                           <td colspan="2">
                                               <asp:DropDownList runat="server" ID="ddl_puesto" CssClass="tbxreg" AutoPostBack="true"></asp:DropDownList>
                                ...
                                <div style="text-align:center;">
                                    <table style="text-align:center; width:100%;">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox runat="server" ID="txtUser" CssClass="tbxreg_min" MaxLength="20"></asp:TextBox>
                                            ...
                                            <td>
                                                <asp:TextBox runat="server" ID="txtPass" CssClass="tbxreg_min" TextMode="Password" MaxLength="20"></asp:TextBox>
                                            ...
                                            <td>
                                                <asp:TextBox runat="server" ID="txtCPass" CssClass="tbxreg_min" TextMode="Password" MaxLength="20"></asp:TextBox>
                                    ...
                                    <tr><td><div class="tituloceldaNegrita" style="text-align:center; padding: 20px 0px 10px 0px"> <asp:Label runat="server" ID="lbl_asig" Text=""></asp:Label></div></td></tr>
                                        ...
                                        <asp:GridView runat="server" ID="gv_carreras" RowStyle-CssClass="gvrow" AutoGenerateColumns="false" GridLines="None"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Pertenece">
                                                    <ItemTemplate>
                                                        <div  style="text-align:center">
                                                            <asp:CheckBox runat="server" ID="cbx_pertenece"  />
