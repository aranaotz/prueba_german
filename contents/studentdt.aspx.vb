...
Partial Class contents_studentdt
    ...
    Protected Sub lb_gvresultado_Click(sender As Object, e As EventArgs)
        ...
        Try
            cacoensulu(llena_detalle(hf_id.Value))
    ...
    Private Sub cacoensulu(ByVal dt As DataTable)
        ...
        lbl_contra.Text = dt.Rows(0).Item(22).ToString
    End Sub
    ...
    Protected Sub lb_generar_Click(sender As Object, e As EventArgs)
        ...
        actualizaContra(substring1 + substring2 + System.Convert.ToString(numero.Next(1000, 9999)), hf_id.Value)

        cacoensulu(llena_detalle(hf_id.Value))
        mv_studentdt.ActiveViewIndex = 2
    End Sub
