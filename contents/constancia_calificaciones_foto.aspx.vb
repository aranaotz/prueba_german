Imports escolar
Imports se_docs
Partial Class contents_constancia_calificaciones_foto
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not IsPostBack Then
            mv_contastancia_calificaciones_foto.ActiveViewIndex = 0
        End If
    End Sub
    ...
    Protected Sub lb_gvresultado_Click(sender As Object, e As EventArgs)
        ...
        Response.Redirect("~/contents/crv_se/rpt_constancia_calificaciones_foto.aspx?ma=" + matricula)
    End Sub
