<%@ Page Title="" Language="VB" MasterPageFile="~/logins/logins.master" AutoEventWireup="false" CodeFile="constancia_calificaciones_foto.aspx.vb" Inherits="contents_constancia_calificaciones_foto" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cph_content" Runat="Server">
     <asp:MultiView runat="server" ID="mv_contastancia_calificaciones_foto">

                <asp:View runat="server" ID="v_cero">

                             <table class="centrado"><tr><td class="titulocategoria" style="text-align: center; padding: 20px 0px 20px 0px;" colspan="3">Constancia con calificaciones y fotografía</td></tr><tr><td>
