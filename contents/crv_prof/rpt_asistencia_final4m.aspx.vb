...
Partial Class contents_crv_prof_rpt_asistencia_final4m
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        objrep.Load(Context.Server.MapPath("../reportes_prof/cr_asistencias_final4m.rpt"))
        ...
        objrep.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, True, "Reporte finalm4_" & icu + "_" + Date.Now)
