<%@ Page Title="" Language="VB" MasterPageFile="~/logins/logins.master" AutoEventWireup="false" CodeFile="constancia_sencilla.aspx.vb" Inherits="contents_constancia_sencilla" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_content" Runat="Server">
            ...
            <asp:MultiView runat="server" ID="mv_contastancia_sencilla">

                <asp:View runat="server" ID="v_cero">

                             <table class="centrado"><tr><td class="titulocategoria" style="text-align: center; padding: 20px 0px 20px 0px;" colspan="3">Constancia de estudios sencilla</td></tr><tr><td>
