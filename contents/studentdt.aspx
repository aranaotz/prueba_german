<%@ Page Title="" Language="VB" MasterPageFile="~/contents/masters/user.master" AutoEventWireup="false" CodeFile="studentdt.aspx.vb" Inherits="contents_studentdt" %>
        ...
        <ContentTemplate>
            <asp:MultiView runat="server" ID="mv_studentdt">
                <asp:View runat="server" ID="v_cero">
                 ...
                 <asp:view ID="v_uno" runat="server">
                ...
                <asp:View runat="server" ID="v_dos">
                    <div class="topbar"><table><tr><td><asp:ImageButton ID="ib_vuelve" runat="server" ImageUrl="~/img/arrowback.png" OnClick="ib_back_Click"/></td><td style="padding: 0px 10px 0px 10px; font-size: 2em; color: #fff; vertical-align: top;">|</td>
                                ...
                                <div>
                                    ...
                                    <div class="titulocelda" style="text-align:center">La contraseña se actualizó correctamente</div>
                                    <div class="titulocelda" style="text-align:center"><strong><asp:Label runat="server" ID="lbl_contra"></asp:Label></strong></div>
                                </div>
