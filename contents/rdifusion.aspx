<%@ Page Title="" Language="VB" MasterPageFile="../logins/logins.master"  AutoEventWireup="false" CodeFile="rdifusion.aspx.vb" Inherits="contents_rdifusion" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cph_content" Runat="Server">
    <asp:UpdatePanel runat="server" ID="up_rdifusion">
        <ContentTemplate>
            <asp:MultiView runat="server" ID="mv_rdifusion">
                <asp:View runat="server" ID="v_cero">
                     ...
                     <div>
                        <table class="tablacien">
                            <tr><td>
                                <table class="tablacien">
                                    <tr><td class="titulo_medio" style="padding: 5px 5px 15px 5px;">Reporte de medios de difusion de aspirantes UTJ</td></tr>
                ...
                <asp:View runat="server" ID="v_uno">
                    ...
                    <div>
                        <table class="tablacien">
                            ...
                            <tr><td>
                                <div>
                                    <asp:GridView runat="server" ID="gv_difusion" AutoGenerateColumns="false"  GridLines="None" RowStyle-CssClass="gvrow"
                                         HorizontalAlign="Center" style="border: solid 1px #ccc;" CellPadding="5" CellSpacing="5  " EmptyDataText=":( No hay datos para mostrar">
                                        <AlternatingRowStyle CssClass="gvrow_alt" />
                                        <Columns>
                                            <asp:BoundField DataField="medio" HeaderText="Medio" ReadOnly="true" SortExpression="medio" >
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="left" VerticalAlign="Middle" />
                                            </asp:BoundField>
                                             <asp:BoundField DataField="cuentamat" HeaderText="Mat" ReadOnly="true" SortExpression="cuentamat" >
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="left" VerticalAlign="Middle" />
                                            </asp:BoundField>
                                             <asp:BoundField DataField="cuentavesp" HeaderText="Vesp" ReadOnly="true" SortExpression="cuentavesp" >
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="left" VerticalAlign="Middle" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="cuenta" HeaderText="Total" ReadOnly="true" SortExpression="cuenta" >
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="left" VerticalAlign="Middle" />
                                            </asp:BoundField>
                                        </Columns>
