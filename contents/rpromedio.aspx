<%@ Page Title="SIAAA - Reporte de promedio de aspirantes" Language="VB" MasterPageFile="../logins/logins.master" AutoEventWireup="false" CodeFile="rpromedio.aspx.vb" Inherits="contents_rpromedio" %>
            ...
            <asp:MultiView runat="server" ID="mv_rpromedio">
                ...
                <asp:View runat="server" ID="v_uno">
                    ...
                    <div>
                        ...
                        <tr><td>
                            <div>
                                <asp:GridView runat="server" ID="gv_promedio" GridLines="None" AutoGenerateColumns="False" RowStyle-CssClass="gvrow" 
                                    HorizontalAlign="Center" style="border: solid 1px #ccc;" CellSpacing="0" CellPadding="10"  EmptyDataText=":( No hay datos importados">
                                    <AlternatingRowStyle CssClass="gvrow_alt"/>
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="PTS" HeaderText="Puntaje EXANI" ReadOnly="true" SortExpression="PTS" >
                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        <ItemStyle HorizontalAlign="center" VerticalAlign="Middle" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="EXAMEN" HeaderText="Calificacion EXANI" ReadOnly="true" SortExpression="EXAMEN" >
                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        <ItemStyle HorizontalAlign="center" VerticalAlign="Middle" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="SUMA" HeaderText="Promedio" ReadOnly="true" SortExpression="SUMA" >
                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        <ItemStyle HorizontalAlign="center" VerticalAlign="Middle" />
                                        </asp:BoundField>
                                    </Columns>
                            ...
                            <asp:GridView runat="server" ID="gv_listado" AutoGenerateColumns="false" GridLines="None" RowStyle-CssClass="gvrow" HorizontalAlign="center"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Clave">
                                        <ItemTemplate>
                                            <div>   
                                                <asp:LinkButton runat="server" ID="lb_clave" Text='<%# Bind("CARRERA")%>' CssClass="texto_boton_gv" OnClick="lb_clave_Click" CommandArgument='<%# Bind("CARRERA")%>'>
