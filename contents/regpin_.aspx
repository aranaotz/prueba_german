<%@ Page Title="Formulario de Primer Ingreso - SIAAA UTJ" Language="VB" MasterPageFile="~/logins/logins.master" AutoEventWireup="false" CodeFile="regpin_.aspx.vb" Inherits="regpin_" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_content" Runat="Server">
    <%--<script type="text/javascript">
        function CheckIfCheckBoxListIsChecked(source, args) {
            var chkList = document.getElementById('<%= cbx_47.ClientID%>');
    ...
    <%--<script type="text/javascript">
        function CheckIfCheckBoxListIsChecked2(source, args) {
            var chkList = document.getElementById('<%= cbx_73.ClientID%>');
            var chk = chkList.getElementsByTagName("input");
            for (var i = 0; i < chk.length; i++) {
                if (chk[i].checked) {
                    args.IsValid = true;
   ...
   <script type="text/javascript">
    ...
    <div style="padding-bottom: 200px;">
           ...
           <td rowspan="2" class="celdascien" style="width: 48%;">
               <asp:UpdatePanel ID="up_actuales" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional"><ContentTemplate>
                   <table class="tablacien" style="width: 100%; text-align: left;"><tr>
                          ...
                          <tr>            
                          <td class="celdascien" style="width: 33%;"><asp:TextBox ID="tbx_13" runat="server" CssClass="tbxreg" ReadOnly="true" MaxLength="100" AutoCompleteType="HomeState"></asp:TextBox></td>
                          <td class="celdascien" style="width: 33%;"><asp:TextBox ID="tbx_14" runat="server" CssClass="tbxreg" ReadOnly="true" MaxLength="50" AutoCompleteType="HomeCity"></asp:TextBox></td>
                          <td class="celdascien" style="width: 33%;"><asp:TextBox ID="tbx_15" runat="server" CssClass="tbxreg" ReadOnly="true" MaxLength="50" AutoCompleteType="HomeState"></asp:TextBox></td>
        ...
        <tr><td>
            ...
            <asp:RequiredFieldValidator ID="rfv_fecha" runat="server" ValidationGroup="reg" ControlToValidate="tbx_fechavalid" Display="None"></asp:RequiredFieldValidator>
...
<%'----------------------CODIGO DEL LOADING----------------------------- %>
<%--        <asp:UpdatePanelAnimationExtender ID="up_general" runat="server" 
                 Enabled="True" TargetControlID="p_test">
                       <Animations>
                            <OnUpdating>
                                  <Parallel duration="0.5" fps="30">
                                  <FadeOut AnimationTarget="p_test" minimumOpacity="0" ForceLayoutInIE="true"/>
                                  </Parallel>
                           </OnUpdating>
                           <OnUpdated>
                                <Parallel duration="0.5" fps="30">
                                  <FadeIn Animationtarget="p_test" minimumOpacity="0" ForceLayoutInIE="true"/>
                                  </Parallel>
                             </OnUpdated>
                   </Animations>
            </asp:UpdatePanelAnimationExtender> 
  
            <asp2:ModalUpdateProgress ID="mup_ping" runat="server" AssociatedUpdatePanelID = "p_test"
                      BackgroundCssClass="background_blanco" CancelControlID="lb_cancel" 
                      DisplayAfter="600"><ProgressTemplate>
