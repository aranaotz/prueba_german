<%@ Page Title="" Language="VB" MasterPageFile="~/contents/masters/user.master" AutoEventWireup="false" CodeFile="general_ciclos.aspx.vb" Inherits="contents_general_ciclos" %>
            ...
            <asp:MultiView runat="server" ID="mv_general_ciclos">
                ...
                <asp:View runat="server" ID="v_dos">
                    ...
                    <div class="topbar"><table><tr><td><asp:ImageButton ID="un_atras" runat="server" ImageUrl="~/img/arrowback.png" OnClick="un_atras_Click" /></td><td style="padding: 0px 10px 0px 10px; font-size: 2em; color: #fff; vertical-align: top;">|</td>
                        <td style="font-size: 1.5em;"><asp:Linkbutton runat="server" ID="lb_actualiza" Text="Actualizar" CssClass="boton_texto_dentro" OnClick="lb_actualiza_Click" ValidationGroup="gciclo"/></td>
                        </tr></table></div>
                        ...
                        <div class="titulocategoria" style="text-align:left;padding-top:20px;padding-left:150px">Actividades Académicas</div>
                      
                        <div>
                            <table style="width:100%;padding-left:150px">
                                <tr>
                                    <td style="width:20%;text-align:right">Inicio de clases</td>
                                    <td style="padding-left:20px;text-align:left;padding-top:20px"><asp:TextBox runat="server" ID="tbx_inicio" CssClass="tbxreg" Width="200px"></asp:TextBox></td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left:20px;text-align:left;padding-top:20px"><asp:TextBox runat="server" ID="tbx_inicio_continua" CssClass="tbxreg" Width="200px"></asp:TextBox></td>
                                  ...
                                  <tr>
                                    ...
                                    <td style="padding-left:20px;text-align:left;padding-top:20px"><asp:TextBox runat="server" ID="tbx_fin_continua" CssClass="tbxreg" Width="200px"></asp:TextBox></td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left:20px;text-align:left;padding-top:20px"><asp:TextBox runat="server" ID="tbx_inicio_estadia" CssClass="tbxreg" Width="200px"></asp:TextBox></td>
                                 ...
                                 <tr>
                                    ...
                                    <td style="padding-left:20px;text-align:left;padding-top:20px"><asp:TextBox runat="server" ID="tbx_fin_estadia" CssClass="tbxreg" Width="200px"></asp:TextBox></td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left:20px;text-align:left;padding-top:20px"><asp:TextBox runat="server" ID="tbx_fin_curso" CssClass="tbxreg" Width="200px"></asp:TextBox></td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left:20px;text-align:left;padding-top:20px"><asp:TextBox runat="server" ID="tbx_inicio_remediales" CssClass="tbxreg" Width="200px"></asp:TextBox></td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left:20px;text-align:left;padding-top:20px"><asp:TextBox runat="server" ID="tbx_fin_remediales" CssClass="tbxreg" Width="200px"></asp:TextBox></td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left:20px;text-align:left;padding-top:20px"><asp:TextBox runat="server" ID="tbx_inicio_reg_remediales" CssClass="tbxreg" Width="200px"></asp:TextBox></td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left:20px;text-align:left;padding-top:20px"><asp:TextBox runat="server" ID="tbx_fin_reg_remediales" CssClass="tbxreg" Width="200px"></asp:TextBox></td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left:20px;text-align:left;padding-top:20px"><asp:TextBox runat="server" ID="tbx_fin" CssClass="tbxreg" Width="200px"></asp:TextBox></td>
                        ...
                        <div style="float:right;position:relative; bottom:665px;left:800px">
                                    ...
                                    <table style="width:100%;padding-left:30px">
                                        <tr>
                                            ...
                                            <td style="padding-left:20px;text-align:left;padding-top:20px">
                                                <asp:TextBox runat="server" ID="tbx_no_laborables" CssClass="tbxreg" Width="200px"></asp:TextBox> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width:20%;text-align:right">(Si existe más de un día no laborable agregar la(s) fecha(s) en este campo de texto separadas por comas)</td>
                                            <td style="padding-left:20px;text-align:left;padding-top:20px">
                                                <asp:TextBox runat="server" ID="tbx_otro" CssClass="tbxreg" Width="400px"></asp:TextBox> 
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-left:20px;text-align:left;padding-top:20px"><asp:TextBox runat="server" ID="tbx_inicio_vacaciones"  CssClass="tbxreg" Width="200px"></asp:TextBox></td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-left:20px;text-align:left;padding-top:20px"><asp:TextBox runat="server" ID="tbx_fin_vacaciones"  CssClass="tbxreg" Width="200px"></asp:TextBox></td>
