<%@ Page Title="Formulario de Primer Ingreso - SIAAA UTJ" Language="VB" MasterPageFile="masters/synwol.master" AutoEventWireup="false" CodeFile="regpin.aspx.vb" Inherits="regpin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_start" Runat="Server">
  ...
  <script type="text/javascript">
        function MessageBox()
        {
         var radiobutton = document.forms[0].elements['<%=rbl_49.ClientID%>'];
    ...
    <%-- funcion para deshabilitar boton de guardar --%>
   ...
   <script type="text/javascript">
    ...
    <div style="padding-bottom: 200px;">
        ...
        <tr><td class="titulocategoria">Registro TSU</td></tr>
        ...
        <tr><td>
            <asp:UpdatePanel ID="up_carreras" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional"><ContentTemplate>
              <table class="tablacien" style="text-align: left;"><tr><td class="titulocelda">Elije la carrera que deseas ingresar</td><td class="titulocelda">Turno al que asistirás a clases</td></tr>
               <tr>
              <td class="celdascien" style="width: 80%"><asp:DropDownList ID="ddl_carreras" runat="server" CssClass="ddlreg_cien" AutoPostBack="True" ValidationGroup="reg"></asp:DropDownList></td>
              <td class="celdascien" style="width: 20%"><asp:DropDownList ID="ddl_turno" runat="server" CssClass="ddlreg_cien" ValidationGroup="reg"></asp:DropDownList></td></tr></table>
        ...
        <table class="tablacien" style="text-align: left;"><tr><td class="titulocelda">Nombres</td><td class="titulocelda">Primer Apellido</td><td class="titulocelda">Segundo Apellido</td><td class="titulocelda">Sexo</td><td class="titulocelda">Tipo de Sangre</td><td class="titulocelda">Estado Civil</td><td class="titulocelda">Nacionalidad</td></tr><tr><td class="celdascien" style="width: 33%">
            <asp:TextBox ID="tbx_1" runat="server" CssClass="tbxreg" MaxLength="50" AutoCompleteType="FirstName"></asp:TextBox></td><td class="celdascien" style="width: 33%"><asp:TextBox ID="tbx_2" runat="server" CssClass="tbxreg" MaxLength="50" AutoCompleteType="LastName"></asp:TextBox>
            </td><td class="celdascien" style="width: 33%"><asp:TextBox ID="tbx_3" runat="server" CssClass="tbxreg" MaxLength="50"></asp:TextBox></td>
            <td class="celdascero"><asp:DropDownList ID="ddl_4" runat="server" CssClass="ddlreg">
            ...
            <td class="celdascero"><asp:DropDownList ID="ddl_5" runat="server" CssClass="ddlreg">
                <asp:ListItem Text="Elije uno..." Value="0"></asp:ListItem>
            ...
            <td class="celdascero"><asp:DropDownList ID="ddl_6" runat="server" CssClass="ddlreg">
                <asp:ListItem Text="Elije uno..." Value="0"></asp:ListItem>
            ...
            <td class="celdascero">
               <asp:UpdatePanel runat="server" ID="up_nacionalidad" ChildrenAsTriggers="false" UpdateMode="Conditional">
                   <ContentTemplate>
                       <asp:DropDownList ID="ddl_nacionalidad" runat="server" CssClass="ddlreg" AutoPostBack="true">
        ...
        <tr><td class="celdascien">
            <table class="tablacien" style="text-align: left;"><tr><td class="titulocelda">Fecha de nacimiento</td><td class="titulocelda">Lugar de nacimiento</td><td></td><td>Perteneces a alguna etnia</td></tr>
            <tr><td class="celdacero" style="vertical-align: top;">
                <table class="tablainterna" style="width: 0%; text-align: left;">
                    ...
                    <asp:DropDownList ID="ddl_7" runat="server" CssClass="ddlreg_short">
                    ...
                    <td class="celdascero"><asp:DropDownList ID="ddl_8" runat="server" CssClass="ddlreg_short">
                    ...
                    <td class="celdascero"><asp:DropDownList ID="ddl_9" runat="server" CssClass="ddlreg_short">
                        ...
                        <table class="tablainterna" style="text-align: left;"><tr>
                            <td class="celdascien" style="width: 100%">
                                <asp:UpdatePanel ID="up_tbx_10" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional"><ContentTemplate>
                                    <asp:TextBox ID="tbx_10" runat="server" CssClass="tbxreg" ReadOnly="true" MaxLength="200" AutoCompleteType="Disabled"></asp:TextBox>
                            ...
                            <td class="celdacero"><asp:Button ID="cmd_bln" runat="server" Text="Buscar población" CssClass="botones" style="font-size: 100%;" CausesValidation="False"/></td>
                            
                              <td class="celdascero">
                               <asp:UpdatePanel runat="server" ID="up_etnias" ChildrenAsTriggers="false" UpdateMode="Conditional">
                               <ContentTemplate>
                                   <asp:DropDownList ID="ddl_etnias" runat="server" CssClass="ddlreg_cien" AutoPostBack="true" Width="200px">
        ...
        <tr><td><table class="tablacien" style="width: 100%; text-align: left;"><tr><td class="titulocelda">Dirección actual: Calle y número</td><td class="titulocelda">Código postal</td><td class="titulocelda"></td>
           <td rowspan="2" class="celdascien" style="width: 48%;">
               <asp:UpdatePanel ID="up_actuales" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional"><ContentTemplate>
                   <table class="tablacien" style="width: 100%; text-align: left;"><tr>
                          <td class="titulocelda"><asp:Label runat="server" ID="lbl_colonia" Text=""></asp:Label></td><td class="titulocelda"><asp:Label runat="server" ID="lbl_ciudad" Text=""></asp:Label></td><td class="titulocelda"><asp:Label runat="server" ID="lbl_estado" Text=""></asp:Label></td></tr>
                          <tr>            
                          <td class="celdascien" style="width: 33%;"><asp:TextBox ID="tbx_13" runat="server" CssClass="tbxreg" ReadOnly="true" MaxLength="100" AutoCompleteType="HomeState" Visible="False"></asp:TextBox></td>
                          <td class="celdascien" style="width: 33%;"><asp:TextBox ID="tbx_14" runat="server" CssClass="tbxreg" ReadOnly="true" MaxLength="50" AutoCompleteType="HomeCity" Visible="False"></asp:TextBox></td>
                          <td class="celdascien" style="width: 33%;"><asp:TextBox ID="tbx_15" runat="server" CssClass="tbxreg" ReadOnly="true" MaxLength="50" AutoCompleteType="HomeState" Visible="False"></asp:TextBox></td>
                      ...
                      <Triggers>
                          ...
                          <td class="celdascien" style="width: 40%;"><asp:TextBox ID="tbx_11" runat="server" CssClass="tbxreg" MaxLength="200" AutoCompleteType="HomeStreetAddress"></asp:TextBox></td>
                          <td class="celdascien" style="width: 15%;"><asp:TextBox ID="tbx_12" runat="server" CssClass="tbxreg" MaxLength="5" AutoCompleteType="HomeZipCode"></asp:TextBox></td>
                          ...
                          <td class="celdacero" style="width: 0%;"><asp:ImageButton ID="ib_bcp" runat="server" ImageUrl="../img/marker.png" ValidationGroup="regcp"/></td>
               </tr></table></td></tr>
         ...
         <tr><td>
             <table class="tablacien" style="text-align: left;"><tr>
                 ...
                 <td class="celdascien" style="width: 10%"><asp:TextBox ID="tbx_16" runat="server" CssClass="tbxreg" MaxLength="10"></asp:TextBox></td>
                 <td class="celdascien" style="width: 10%"><asp:TextBox ID="tbx_17" runat="server" CssClass="tbxreg" MaxLength="10"></asp:TextBox></td>
                 <td class="celdascien" style="width: 10%"><asp:TextBox ID="tbx_18" runat="server" CssClass="tbxreg" MaxLength="10"></asp:TextBox></td>
                 <td class="celdascien" style="width: 40%"><asp:TextBox ID="tbx_19" runat="server" CssClass="tbxreg"></asp:TextBox></td>
                 <td class="celdascien" style="width: 16%"><asp:TextBox ID="tbx_20" runat="server" CssClass="tbxreg_min" ReadOnly="True"></asp:TextBox></td>
                 <td class="celdascien" style="width: 7%"><asp:TextBox ID="tbx_21" runat="server" CssClass="tbxreg" MaxLength="3"></asp:TextBox></td>
                 <td class="celdascien" style="width: 7%"><asp:TextBox ID="tbx_22" runat="server" CssClass="tbxreg" MaxLength="3"></asp:TextBox></td></tr></table>
             </td></tr>
        ...
        <tr><td>
            <table class="tablacien" style="width: 100%; text-align: left;"><tr><td>Bachillerato de procedencia</td><td></td><td>Ingreso</td><td>Egreso</td><td>Promedio</td></tr>
                   <tr><td class="celdascien" style="width: 100%;">
                       ...
                       <asp:TextBox ID="tbx_23" runat="server" CssClass="tbxreg" ReadOnly="true"></asp:TextBox>
                       </ContentTemplate>
                           <Triggers>
                       ...
                       <td class="celdascien"  style="width: 0%;"><asp:Button ID="cmd_besc" runat="server" Text="Buscar bachillerato" CssClass="botones" style="font-size: 100%;" CausesValidation="False"/></td>
                       <td class="celdacero" style="vertical-align: top;"><table class="tablainterna" style="width: 0%; text-align: left;"><tr><td class="celdascero"><asp:DropDownList ID="ddl_24" runat="server" CssClass="ddlreg_short">
                    ...
                    <td class="celdascero"><asp:DropDownList ID="ddl_25" runat="server" CssClass="ddlreg_short">
                        <asp:ListItem Text="Mes..." Value="0"></asp:ListItem>
                        <asp:ListItem Text="Enero" Value="01"></asp:ListItem>
                        <asp:ListItem Text="Febrero" Value="02"></asp:ListItem>
                        <asp:ListItem Text="Marzo" Value="03"></asp:ListItem>
                       ...
                       <td class="celdacero" style="vertical-align: top;"><table class="tablainterna" style="width: 0%; text-align: left;"><tr><td class="celdascero"><asp:DropDownList ID="ddl_26" runat="server" CssClass="ddlreg_short" ValidationGroup="reg">
                    <asp:ListItem Text="Año..." Value="0"></asp:ListItem>
                    ...
                    <td class="celdascero"><asp:DropDownList ID="ddl_27" runat="server" CssClass="ddlreg_short" ValidationGroup="reg">
                        <asp:ListItem Text="Mes..." Value="0"></asp:ListItem>
                        <asp:ListItem Text="Enero" Value="01"></asp:ListItem>
                        <asp:ListItem Text="Febrero" Value="02"></asp:ListItem>
                        <asp:ListItem Text="Marzo" Value="03"></asp:ListItem>
                       ...
                       <td class="celdascien" style="width: 0%;"><asp:TextBox ID="tbx_28" runat="server" CssClass="tbxreg"></asp:TextBox></td></tr></table>
            </td></tr><tr><td>
                <table class="tablacien" style="text-align: left;"><tr>
                 
                 <td class="titulocelda">¿Estudiaste tu bachillerato en dos o más instituciones educativas?</td><td class="titulocelda">Tuvo exámenes extraordinaros</td>
                 <td class="titulocelda">Cuenta con certificado</td></tr><tr>
                 ...
                 <td class="celdascien" style="width: 40%">
                     <asp:UpdatePanel ID="up_bachillerato" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional"><ContentTemplate>
                        <asp:DropDownList ID="ddl_74" runat="server" CssClass="ddlreg_cien" ValidationGroup="reg" AutoPostBack="true">
                 ...
                 <td class="celdascien" style="width: 15%">
                     ...
                     <asp:DropDownList ID="ddl_32" runat="server" CssClass="ddlreg_cien" AutoPostBack="True" ValidationGroup="reg">
                        <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                        <asp:ListItem Text="No" Value="1"></asp:ListItem>
                 ...
                 <td class="celdascien" style="width: 15%">
                     ...
                     <asp:DropDownList ID="ddl_33" runat="server" CssClass="ddlreg_cien" AutoPostBack="True">
                        <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
        ...
        <tr><td>
            ...
            <asp:DropDownList ID="ddl_31" runat="server" CssClass="ddlreg_cien">
                        <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                ...
                <td>
                    <asp:DropDownList ID="ddl_29" runat="server" CssClass="ddlreg_cien" ValidationGroup="reg">
                        <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                        <asp:ListItem Text="Pública" Value="01"></asp:ListItem>
                        <asp:ListItem Text="Privada" Value="02"></asp:ListItem></asp:DropDownList>
                </td>
                <td>
                    <asp:DropDownList ID="ddl_30" runat="server" CssClass="ddlreg_cien" ValidationGroup="reg">
                        <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
            ...
            <asp:TextBox ID="tbx_34" runat="server" CssClass="tbxreg" TextMode="MultiLine" Rows="5"></asp:TextBox></td><td class="celdascien" style="width: 50%"><asp:TextBox ID="tbx_35" runat="server" CssClass="tbxreg" TextMode="MultiLine" Rows="5"></asp:TextBox></td></tr></table>
        </td></tr>
            <tr><td>
                <table class="tablacien" style="text-align: left;">
                    <tr>
                        <td class="titulocelda" style="width:30%">¿Tuviste alguna beca durante tu estancia en el bachillerato?</td><td style="width:5%"></td>
                        <td class="titulocelda" style="width:60%">En caso de convertirte en estudiante de la UTJ, ¿consideras necesario el apoyo con una beca?</td>
                    ...
                    <tr>
                        <td class="titulocelda" style="width:30%">
                            <asp:UpdatePanel runat="server" ID="up_beca" ChildrenAsTriggers="False" UpdateMode="Conditional">
                               <ContentTemplate>
                                   <asp:DropDownList runat="server" ID="ddl_beca" CssClass="ddlreg_cien" AutoPostBack="true" ValidationGroup="reg">
                                    <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                                    <asp:ListItem Text="No" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="Si" Value="2"></asp:ListItem>
                            </asp:DropDownList>
                        ...
                        <td class="titulocelda" style="width:60%">
                            <asp:UpdatePanel runat="server" ID="up_apoyo" ChildrenAsTriggers="False" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:DropDownList runat="server" ID="ddl_apoyo" CssClass="ddlreg_cien" AutoPostBack="true" ValidationGroup="reg">
                                    <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                                    <asp:ListItem Text="No" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="Si" Value="2"></asp:ListItem>
                            </asp:DropDownList>
        ...
        <tr><td>
            <table class="tablacien" style="text-align: left;"><tr>
                ...
                <td class="titulocelda">¿Tiene algún padecimiento crónico?</td>
                 <td class="titulocelda">¿Recibe o ha recibido atención psicológica alguna vez en su vida?</td></tr><tr>
                 ...
                 <td class="celdascien" style="width: 25%">
                     <asp:UpdatePanel ID="up_cronico" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional"><ContentTemplate>
                        <asp:DropDownList ID="ddl_39" runat="server" CssClass="ddlreg_cien" AutoPostBack="true">
                        <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                        <asp:ListItem Text="No" Value="1"></asp:ListItem>
                        <asp:ListItem Text="Si" Value="2"></asp:ListItem></asp:DropDownList>
                     </ContentTemplate>
                 ...
                 <td class="celdascien" style="width: 30%">
                     <asp:UpdatePanel ID="up_psicologico" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional"><ContentTemplate>   
                        <asp:DropDownList ID="ddl_40" runat="server" CssClass="ddlreg_cien" AutoPostBack="True">
                        <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                        <asp:ListItem Text="No" Value="1"></asp:ListItem>
                        <asp:ListItem Text="Si" Value="2"></asp:ListItem></asp:DropDownList>
                     </ContentTemplate>
        ...
        <tr><td>
            <table class="tablacien" style="text-align: left;"><tr>
                 <td class="titulocelda">¿Tiene hijos?</td><td class="titulocelda">¿Vive fuera de la ZMG?</td>
                 <td class="titulocelda">¿Trabaja actualmente?</td><td class="titulocelda">¿Busca empleo?</td>
                 <td class="titulocelda">¿Has hecho trámites a otra Universidad?</td>
                 </tr><tr>
                 <td class="celdascien" style="width: 20%">
                      <asp:UpdatePanel ID="up_hijos" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional"><ContentTemplate>
                        <asp:DropDownList ID="ddl_41" runat="server" CssClass="ddlreg_cien" AutoPostBack="True">
                        <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                        <asp:ListItem Text="No" Value="01"></asp:ListItem>
                        <asp:ListItem Text="Si" Value="02"></asp:ListItem></asp:DropDownList>
                      </ContentTemplate>
                 ...
                 <td class="celdascien" style="width: 20%">
                     <asp:UpdatePanel ID="up_casa" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional"><ContentTemplate>
                        <asp:DropDownList ID="ddl_42" runat="server" CssClass="ddlreg_cien" AutoPostBack="True">
                        <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                        <asp:ListItem Text="No" Value="01"></asp:ListItem>
                        <asp:ListItem Text="Si" Value="02"></asp:ListItem></asp:DropDownList>
                     </ContentTemplate>
                 ...
                 <td class="celdascien" style="width: 20%">
                     ...
                     <asp:DropDownList ID="ddl_43" runat="server" CssClass="ddlreg_cien" AutoPostBack="True">
                        <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                        <asp:ListItem Text="No" Value="01"></asp:ListItem>
                        <asp:ListItem Text="Si" Value="02"></asp:ListItem></asp:DropDownList>
                     </ContentTemplate>
                 ...
                 <td class="celdascien" style="width: 20%"><asp:DropDownList ID="ddl_44" runat="server" CssClass="ddlreg_cien">
                        <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                 ...
                 <td class="celdascien" style="width: 20%">
                     ...
                     <asp:DropDownList ID="ddl_45" runat="server" CssClass="ddlreg_cien" AutoPostBack="True">
                        <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                        <asp:ListItem Text="No" Value="01"></asp:ListItem>
                        <asp:ListItem Text="Si" Value="02"></asp:ListItem></asp:DropDownList>
                         </ContentTemplate>
                ...
                <tr>
                    <td class="titulocelda" style="padding-top:10px;">¿Practicas o te gustaría practicar alguna actividad deportiva o sociocultural?</td>
                </tr>
                <tr>
                    <td class="celdascien">
                     <asp:UpdatePanel ID="up_deportes" runat="server"><ContentTemplate>
                     <asp:DropDownList ID="ddl_deporte" runat="server" CssClass="ddlreg_cien" AutoPostBack="True">
                        <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                        <asp:ListItem Text="No" Value="01"></asp:ListItem>
                        <asp:ListItem Text="Si" Value="02"></asp:ListItem></asp:DropDownList>
                         </ContentTemplate>
        ...
        <tr><td>
            <table class="tablacien" style="text-align: left;"><tr>
                 ...
                 <td class="celdascien" style="width: 100%">
                                                    ...
                                                    <%--<asp:ValidatorCalloutExtender ID="vcoe_cv_dl_razon" runat="server" TargetControlID="cv_dl_razon" CloseImageUrl="../img/close_coe.png" 
                     ...
                     <div style="padding:20px 0 0 0">
                                               <script type="text/javascript">
                                                   function Validate(sender, args) {
                                                       var chkList = document.getElementById('<%= dl_razon.ClientID%>');
                             ...
                             <asp:DataList runat="server" ID="dl_razon" RepeatColumns="2">
                                <ItemTemplate>
        ...
        <tr><td>
            ...
            <table class="tablacien" style="text-align: left;"><tr>
                 ...
                 <td class="celdascien" style="width: 100%">
                                                      ...
                                                      <%-- <asp:ValidatorCalloutExtender ID="vcoe_cv_dl_medios" runat="server" TargetControlID="cv_dl_medios" CloseImageUrl="../img/close_coe.png" 
                                                          CssClass="customCalloutStyle" WarningIconImageUrl="../img/alert_yel.png" Enabled="True">
                                                      </asp:ValidatorCalloutExtender>--%>
                     ...
                     <div style="padding:20px 0 0 0"></div>
                                                     <script type="text/javascript">
                                                         function Validate2(sender, args) {
                                                             var chkList = document.getElementById('<%= dl_medios.ClientID%>');
                                                             var chk = chkList.getElementsByTagName("input");
                                                             for (var i = 0; i < chk.length; i++) {
                                                                 if (chk[i].type == "checkbox" && chk[i].checked) {
                                                                     args.IsValid = true;
                      ...
                      <asp:DataList runat="server" ID="dl_medios" RepeatColumns="2">
                        <ItemTemplate>
        ...
        <tr><td class="titulocelda">El siguiente paso para tu registro es tu entrevista en la UTJ.<br />
                       Elije un día de los marcados en verde y espera un momento a que aparezcan las horas disponibles para la cita; selecciona una y haz click en guardar registro.           
            </td></tr>
        <tr><td class="titulocelda" style="padding-left: 10px;">
            </td></tr>
        <tr><td>
            <asp:UpdatePanel ID="up_calendario" runat="server" UpdateMode="Conditional"><ContentTemplate>
            <div><table><tr><td colspan="2" style="text-align:left;">
                <asp:Textbox ID="tbx_fechavalid" runat="server" ReadOnly="true" CssClass="tbxreg" Width="200px" style="text-align:center;"/>
            <asp:RequiredFieldValidator ID="rfv_fecha" runat="server" ValidationGroup="reg" ControlToValidate="tbx_fechavalid" Display="None" ErrorMessage="Seleccione el día y la hora en el calendario!"></asp:RequiredFieldValidator>
            <asp:ValidatorCalloutExtender ID="vcoe_rfv_fecha" runat="server" TargetControlID="rfv_fecha" CloseImageUrl="../img/close_coe.png" 
                                              CssClass="customCalloutStyle" WarningIconImageUrl="../img/alert_yel.png" Enabled="True"></asp:ValidatorCalloutExtender>
                            </td></tr><tr><td  class="calendarWrapper" style="font-size: 1.0em; padding: 0px 10px 0px 10px; border-radius: 4px;">
            <asp:calendar ID="cal_48" runat="server" CssClass="calendario" 
                ...
                <asp:HiddenField ID="hf_cs" runat="server" />
               
               
                            </td>
            <td style="font-size: 1.2em; padding-left: 10px;">
                <div style="background: rgba(255,106,0,0.8); border-radius: 5px; ">
                <asp:RadioButtonList ID="rbl_49" runat="server" RepeatColumns="2" RepeatDirection="Horizontal" ValidationGroup="reg" CellPadding="4" CellSpacing="4"></asp:RadioButtonList>
                </div>
            </td></tr>
            </table></div>
            </ContentTemplate>
        ...
        <tr><td><table><tr><td style="padding: 10px;">
            <table><tr><td>
            <asp:Button ID="cmd_save" runat="server" Text="Guardar Registro" CssClass="botones" style="font-size: 100%;" OnClientClick="bPreguntar = false;" ValidationGroup="reg"/>
            ...
            <asp:Button ID="cmd_cancelar" runat="server" Text="Cancelar" CssClass="botones" style="font-size: 100%;" CausesValidation="False"/>
                                ...
                                <asp:CustomValidator ID="cv_dl_razon" runat="server" ErrorMessage="Seleccione por lo menos una razón por la cual se inscribe a la UTJ."
                                 ClientValidationFunction="Validate" SetFocusOnError="True" Display="Static" ValidationGroup="reg" CssClass="validator"></asp:CustomValidator><br />
                                <asp:CustomValidator ID="cv_dl_medios" runat="server" ErrorMessage="Seleccione por lo menos un medio por el cual se enteró de la UTJ."
                                 ClientValidationFunction="Validate2" SetFocusOnError="True" Display="Static" ValidationGroup="reg" CssClass="validator"></asp:CustomValidator>
              ...
              <asp:UpdatePanel ID="up_mensajes" runat="server"><ContentTemplate>
                <asp:MultiView ID="mv_msgs" runat="server">
                  <asp:View ID="v_poblacion" runat="server">
                      <table class="popupmsg"><tr><td id="pad">Ingresa el nombre completo o parte de él o código postal de la población en donde naciste, haz click en buscar para encontrar coincidencias.<br />
                                     ...
                                     <asp:Panel ID="p_busqueda1" runat="server" DefaultButton="cmd_buscar_poblacion"><table style="width: 100%"><tr><td id="pad" style="width: 100%;"><asp:TextBox ID="tbx_50" runat="server" CssClass="tbxreg" ValidationGroup="bln"></asp:TextBox></td><td id="pad">
                                         <asp:Button ID="cmd_buscar_poblacion" runat="server" CssClass="botones" Text="Buscar población" style="font-size: 100%;" ValidationGroup="bln" />
                                     </td></tr></table></asp:Panel>
                                      </td></tr><tr><td id="pad"><div style="overflow-x:hidden;overflow-y:scroll;max-height:400px">
                  ...
                  <asp:View ID="v_buscarcp" runat="server">
                      <table class="popupmsg"><tr><td id="pad">Al encontrar la población, haz click en ella para llenar los campos de Colonia, Ciudad y Estado.
                                 </td></tr>
                    ...
                    <asp:View ID="v_escuela" runat="server">
                      <table class="popupmsg"><tr><td id="pad">Ingresa parte del nombre la preparatoria donde estudiaste.<br />
                                     Al encontrarla haz click en ella para enviarla a tu solicitud.
                                 </td></tr><tr><td id="pad">
                                     <asp:Panel ID="p_buscar_escuela" runat="server" DefaultButton="cmd_buscar_escuela"><table style="width: 100%"><tr><td id="pad" style="width: 100%;"><asp:TextBox ID="tbx_bescuela" runat="server" CssClass="tbxreg" ValidationGroup="bes"></asp:TextBox></td><td id="pad">
                                         <asp:Button ID="cmd_buscar_escuela" runat="server" CssClass="botones" Text="Buscar preparatoria" style="font-size: 100%;" ValidationGroup="bes" />
                                     </td></tr></table></asp:Panel>
                                      </td></tr><tr><td id="pad"><div style="overflow-x:hidden;overflow-y:scroll;max-height:400px">
                    ...
                    <asp:View ID="v_extraordinarios" runat="server">
                      <table class="popupmsg"><tr><td id="pad">Referente a los examenes extraordinarios contesta lo siguiente.<br />
                                     ...
                                     <asp:Panel ID="p_extraordinarios" runat="server" DefaultButton="cmd_extraordinarios">
                                         ...
                                         <td id="pad" style="width: 20%;">
                                             <asp:TextBox ID="tbx_51" runat="server" CssClass="tbxreg" ValidationGroup="gext"></asp:TextBox></td>
                                             <td id="pad" style="width: 40%;">
                                                 <asp:TextBox ID="tbx_52" runat="server" CssClass="tbxreg" ValidationGroup="gext"></asp:TextBox></td>
                                                     <td id="pad" style="width: 40%;">
                                                         <asp:TextBox ID="tbx_53" runat="server" CssClass="tbxreg" ValidationGroup="gext"></asp:TextBox></td></tr><tr><td colspan="3" style="text-align: center;">
                                             <table style="margin: auto;"><tr><td id="pad">
                                             <asp:Button ID="cmd_extraordinarios" runat="server" CssClass="botones" Text="Guardar y seguir" style="font-size: 100%;" ValidationGroup="gext" />
                                             </td><td id="pad">
                    ...
                    <asp:View ID="v_certificado" runat="server">
                      <table class="popupmsg"><tr><td id="pad">Referente a la falta de tu certificado contesta lo siguiente.<br />
                                     ...
                                     <asp:Panel ID="p_certificado" runat="server" DefaultButton="cmd_certificado">
                                         ...
                                         <td id="pad" style="width: 80%;">
                                             <asp:TextBox ID="tbx_54" runat="server" CssClass="tbxreg" ValidationGroup="cext"></asp:TextBox></td>
                                             <td id="pad" style="width: 10%;">
                                                 <asp:Button ID="cmd_certificado" runat="server" CssClass="botones" Text="Guardar" style="font-size: 100%;" ValidationGroup="cext" />
                                             </td><td id="pad" style="width: 10%;">
                                                 <asp:Button ID="cmd_cancelarcert" runat="server" CssClass="botones" Text="Cancelar" style="font-size: 100%;" CausesValidation="false"/>
                                          </td></tr></table>
                                     </asp:Panel>
                  ...
                  <asp:View ID="v_cronico" runat="server">
                   <table class="popupmsg">
                       <tr><td id="pad">Referente a los padecimientos cronicos.</td></tr>
                       <tr><td id="pad">
                           <asp:Panel runat="server" ID="p_cronicos" DefaultButton="cmd_cronicos" style="width:100%;">
                               <table style="width:100%;">
                                   <tr>
                                       <td id="pad" style="width:60%; white-space:nowrap">¿Qué enfermedad padeces?</td>
                                       <td id="pad" style="width:40%; white-space:nowrap">¿Recibes algún tratamiento?</td>
                                   </tr>
                                   <tr>
                                       <td id="pad" style="width:60%; white-space:nowrap">
                                           <asp:DropDownList runat="server" ID="ddl_cronicas" CssClass="ddlreg_cien" AutoPostBack="true" ValidationGroup="cronicos"></asp:DropDownList>
                                       ...
                                       <td id="pad" style="width:40%; white-space:nowrap">
                                           <asp:DropDownList runat="server" ID="ddl_tratamiento" CssClass="ddlreg_cien" AutoPostBack="true" ValidationGroup="cronicos">
                                               <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                                               <asp:ListItem Text="No" Value="1"></asp:ListItem>
                                               <asp:ListItem Text="Si" Value="2"></asp:ListItem>
                                           </asp:DropDownList>
                                   ...
                                   <tr>
                                       <td id="pad" style="width:60%; white-space:nowrap">
                                           <asp:TextBox runat="server" ID="tbx_otra" CssClass="tbxreg" ValidationGroup="cronicos"></asp:TextBox>
                                       ...
                                       <td id="pad" style="width:40%; white-space:nowrap">
                                           <asp:TextBox runat="server" ID="tbx_tratamiento" CssClass="tbxreg" ValidationGroup="cronicos"></asp:TextBox>               
                                   ...
                                   <tr>
                                       <td colspan="2" style="text-align: center;">
                                             <table style="margin: auto;">
                                                 <tr>
                                                     <td id="pad">
                                                        <asp:Button ID="cmd_cronicos" runat="server" CssClass="botones" Text="Guardar" style="font-size: 100%;" ValidationGroup="cronicos" />
                                                </td>
                                                     <td id="pad">
                                                        <asp:Button ID="cmd_cancelarcronicos" runat="server" CssClass="botones" Text="Cancelar" style="font-size: 100%;" CausesValidation="false"/>
                                                    </td></tr></table>
                                         </td></tr>
                               </table>
                           </asp:Panel>
                    ...
                    <asp:View ID="v_psicologicos" runat="server">
                      <table class="popupmsg"><tr><td id="pad">Referente a la atención Psicológica.
                                 </td></tr><tr><td id="pad">
                                     <asp:Panel ID="p_psicologicos" runat="server" DefaultButton="cmd_psicologicos" style="width: 100%;">
                                         <table style="width: 100%"><tr><td id="pad" style="width: 60%; white-space: nowrap">
                                             ¿Qué tipo de atención recibe actualmente o recibió alguna vez?</td><td id="pad" style="width: 40%; white-space: nowrap">
                                                 ¿Hace cuánto tiempo?</td></tr><tr>
                                         <td id="pad" style="width: 60%;">
                                             <asp:TextBox ID="tbx_57" runat="server" CssClass="tbxreg" ValidationGroup="psico"></asp:TextBox></td>
                                             <td id="pad" style="width: 40%;">
                                                 <asp:DropDownList ID="ddl_58" runat="server" CssClass="ddlreg_cien" ValidationGroup="psico">
                                                   <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                                             ...
                                             <table style="margin: auto;"><tr><td id="pad">
                                             <asp:Button ID="cmd_psicologicos" runat="server" CssClass="botones" Text="Guardar" style="font-size: 100%;" ValidationGroup="psico" />
                                             </td><td id="Td16">
                    ...
                    <asp:View ID="v_hijos" runat="server">
                      <table class="popupmsg"><tr><td id="pad">Referente a los hijos...
                                 </td></tr><tr><td id="pad">
                                     <asp:Panel ID="p_hijos" runat="server" DefaultButton="cmd_hijos">
                                         <table style="width: 100%"><tr><td id="pad" style="width: 30%; white-space: nowrap">
                                             ¿Cuantos hijos tiene?</td><td id="pad" style="width: 70%; white-space: nowrap">
                                                 Escriba sus edades.<br />Separe con una coma en caso de que sean más de uno.</td></tr><tr>
                                         <td id="pad" style="width: 30%;">
                                             <asp:DropDownList ID="ddl_59" runat="server" CssClass="ddlreg_cien" ValidationGroup="hijos">
                                                   <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                                             ...
                                             <td id="pad" style="width: 70%;">
                                                 <asp:TextBox ID="tbx_60" runat="server" CssClass="tbxreg" ValidationGroup="hijos"></asp:TextBox></td>
                  ...
                  <asp:View ID="v_casa" runat="server">
                      <table class="popupmsg"><tr><td id="pad">Referente a tu domicilio fuera la ZMG...
                                 </td></tr><tr><td id="pad">
                                     <asp:Panel ID="p_casa" runat="server" DefaultButton="cmd_casa">
                                         <table style="width: 100%"><tr><td id="pad" style="width: 100%;">
                                             Al ingresar a la UTJ, tu domicilio será...</td></tr><tr>
                                         <td id="pad" style="width: 100%;">
                                             <asp:DropDownList ID="ddl_61" runat="server" CssClass="ddlreg_cien" ValidationGroup="casa">
                                                   <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                                             ...
                                             <table style="margin: auto;"><tr><td id="pad">
                                             <asp:Button ID="cmd_casa" runat="server" CssClass="botones" Text="Aceptar" style="font-size: 100%;" ValidationGroup="casa" />
                                             </td><td id="pad">
                  ...
                  <asp:View ID="v_trabajo" runat="server">
                      <table class="popupmsg"><tr><td id="pad">Referente al tema laboral, contesta lo siguiente:<br />
                                     ...
                                     <asp:Panel ID="p_trabajo" runat="server" DefaultButton="cmd_trabajo" style="width: 100%;">
                                         ...
                                         <td id="pad" style="width: 33%;">
                                             <asp:TextBox ID="tbx_62" runat="server" CssClass="tbxreg" ValidationGroup="labor"></asp:TextBox></td>
                                             <td id="pad" style="width: 33%;">
                                                 <asp:TextBox ID="tbx_63" runat="server" CssClass="tbxreg" ValidationGroup="labor"></asp:TextBox></td>
                                                     <td id="pad" style="width: 34%;">
                                         ...
                                         <td id="pad" style="width: 33%;">
                                             <asp:TextBox ID="tbx_65" runat="server" CssClass="tbxreg" ValidationGroup="labor"></asp:TextBox>
                                             <td id="pad" style="width: 33%;">
                                                 
                                                     <asp:DropDownList ID="ddl_66" runat="server" CssClass="ddlreg_cien" ValidationGroup="labor">
                                                         <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                                                         <asp:ListItem Text="No" Value="01"></asp:ListItem>
                                                     ...
                                                     <td id="pad" style="width: 34%;">
                                                         ...
                                                         <asp:DropDownList ID="ddl_67" runat="server" CssClass="ddlreg_cien" ValidationGroup="labor">
                                                             <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                                                             <asp:ListItem Text="No" Value="01"></asp:ListItem>
                                                             <asp:ListItem Text="Si" Value="02"></asp:ListItem>
                                                         </asp:DropDownList>
                                             ...
                                             <table style="margin: auto;"><tr><td id="pad">
                                             <asp:Button ID="cmd_trabajo" runat="server" CssClass="botones" Text="Guardar y seguir" style="font-size: 100%;" ValidationGroup="labor" />
                                             </td><td id="pad">
                    ...
                    <asp:View ID="v_registro" runat="server">
                      <table class="popupmsg"><tr><td id="pad">Por favor responde sobre tu anterior tramite a otra universidad:<br />
                                     ...
                                     <asp:Panel ID="p_registro" runat="server" DefaultButton="cmd_registro">
                                         ...
                                         <td id="pad" style="width: 33%;">
                                             ...
                                             <asp:DropDownList ID="ddl_68" runat="server" CssClass="ddlreg_cien" ValidationGroup="registro">
                                             </asp:DropDownList>
                                         </td>
                                             <td id="pad" style="width: 33%;">
                                             
                                             <asp:DropDownList ID="ddl_69" runat="server" CssClass="ddlreg_cien" ValidationGroup="registro">
                                                <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                                             ...
                                             <asp:DropDownList ID="ddl_70" runat="server" CssClass="ddlreg_cien" ValidationGroup="registro">
                                                <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                                             ...
                                             <tr>
                                                 <td colspan="3" style="text-align: center; width: 100%">
                                                     <table style="width: 100%; margin: auto;"><tr><td id="pad" style="width: 50%;">De que especialidad era la carrera</td><td id="pad" style="width: 50%;">Especificamente a que carrera hiciste trámite</td></tr>
                                                         <tr><td id="pad" style="width: 50%;">
                                                             
                                                             <asp:DropDownList ID="ddl_71" runat="server" CssClass="ddlreg_cien" ValidationGroup="registro">
                                                                <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                                                             ...
                                                             </td><td id="pad" style="width: 50%;">

                                                                 <asp:TextBox ID="tbx_72" runat="server" CssClass="tbxreg" ValidationGroup="registro"></asp:TextBox>
                                             ...
                                             <tr><td colspan="3" style="text-align: center;">
                                             <table style="margin: auto;"><tr><td id="pad">
                                             <asp:Button ID="cmd_registro" runat="server" CssClass="botones" Text="Guardar y seguir" style="font-size: 100%;" ValidationGroup="registro" />
                                             </td><td id="pad">
                  ...
                  <asp:View ID="v_bachillerato" runat="server">
                      <table class="popupmsg"><tr><td id="pad">Referente a las escuelas en donde cursaste el bachillerato...<br />Pulsa Aceptar para continuar.
                                 </td></tr><tr><td id="pad">
                                     <asp:Panel ID="p_bachillerato" runat="server" DefaultButton="cmd_bachillerato">
                                         ...
                                         <td id="pad" style="width: 100%;">
                                             <asp:DropDownList ID="ddl_75" runat="server" CssClass="ddlreg_cien" ValidationGroup="bachillerato">
                                                   <asp:ListItem Text="Selecciona..." Value="0"></asp:ListItem>
                                                   <asp:ListItem Text="Si" Value="01"></asp:ListItem>
                                             ...
                                             <table style="margin: auto;"><tr><td id="pad">
                                             <asp:Button ID="cmd_bachillerato" runat="server" CssClass="botones" Text="Aceptar" style="font-size: 100%;" ValidationGroup="bachillerato" />
                                             </td><td id="pad">
                    ...
                    <asp:View runat="server" ID="v_doce">
                         <table class="popupmsg">
                        <tr><td id="pad">Referente a la nacionalidad...</td></tr>
                        <tr><td id="pad">
                            <asp:Panel runat="server" ID="p_nacionalidad" DefaultButton="cmd_aceptar">
                                 <table style="width: 100%"><tr><td id="pad" style="white-space: nowrap" class="auto-style1">
                                             Selecciona tu pais de origen</td></tr><tr>
                                         <td id="pad" style="padding:0 180px 0 180px" >
                                             <asp:DropDownList ID="ddl_paises" runat="server" CssClass="ddlreg_cien" ValidationGroup="pais">
                                                  
                                             </asp:DropDownList></td>
                                             
                                             </tr><tr><td colspan="2" style="text-align: center;">
                                             <table style="margin: auto;"><tr><td id="pad">
                                             <asp:Button ID="cmd_aceptar" runat="server" CssClass="botones" Text="Aceptar" style="font-size: 100%;" ValidationGroup="pais" />
                                             </td><td id="pad">
                    ...
                    <asp:View runat="server" ID="v_trece">
                         <table class="popupmsg">
                        <tr><td id="pad">Referente a tu grupo etnico...</td></tr>
                        <tr><td id="pad">
                            <asp:Panel runat="server" ID="p_etnias" DefaultButton="cmd_aceptaretnia">
                                 <table style="width: 100%"><tr><td id="pad" style="width: 30%; white-space: nowrap">
                                             Selecciona tu grupo en las opciones</td></tr><tr>
                                         <td id="pad" style="padding:0 180px 0 180px" >
                                             <asp:DropDownList ID="ddl_grupo_etnico" runat="server" CssClass="ddlreg_cien" ValidationGroup="etnias">
                                                  
                                             </asp:DropDownList></td>
                                             
                                             </tr><tr><td colspan="2" style="text-align: center;">
                                             <table style="margin: auto;"><tr><td id="pad">
                                             <asp:Button ID="cmd_aceptaretnia" runat="server" CssClass="botones" Text="Aceptar" style="font-size: 100%;" ValidationGroup="etnias" />
                                             </td><td id="pad">
                    ...
                    <asp:View runat="server" ID="v_catorce">
                        <table class="popupmsg">
                            <tr><td id="pad" style="padding-top:20px">Referente a tu beca</td></tr>
                            <tr><td id="pad">
                                <asp:Panel runat="server" ID="p_becas" DefaultButton="cmd_becas">
                                    <table style="width: 100%">
                                        <tr><td id="pad" style="white-space: nowrap;padding-top:20px">¿Cuál era el motivo por el que recibías la beca?</td>  
                                        </tr>
                                        <tr><td id="pad" style="white-space: nowrap;padding-top:20px">
                                            <asp:DropDownList runat="server" ID="ddl_becas" CssClass="ddlreg_cien" AutoPostBack="true" ValidationGroup="becas" Width="80%"></asp:DropDownList>
                                        ...
                                        <tr>
                                             <td id="reg" style="white-space: nowrap;padding-top:20px">
                                                <asp:TextBox runat="server" ID="tbx_becas" CssClass="tbxreg" Width="80%"></asp:TextBox>
                                        ...
                                        <tr><td colspan="2" style="text-align: center;padding-top:20px">
                                             <table style="margin: auto;"><tr><td id="pad">
                                             <asp:Button ID="cmd_becas" runat="server" CssClass="botones" Text="Aceptar" style="font-size: 100%;" ValidationGroup="becas" />
                                             </td><td id="pad">
                    ...
                    <asp:View runat="server" ID="v_quince">
                       <table class="popupmsg">
                            <tr><td id="pad" style="padding-top:20px">Sobre el apoyo de beca</td></tr>
                            <tr><td id="pad">
                                <asp:Panel runat="server" ID="p_apoyo" DefaultButton="cmd_apoyo">
                                    <table style="width: 100%">
                                        <tr><td id="reg" style="white-space: nowrap;padding-top:20px">¿Por qué motivo?</td>                                           
                                        </tr>
                                        <tr><td id="reg" style="white-space: nowrap;padding-top:20px">
                                            <asp:DropDownList runat="server" ID="ddl_apoyos" CssClass="ddlreg_cien" AutoPostBack="true"  Width="80%"></asp:DropDownList>
                                        ...
                                        <tr>
                                            <td id="reg" style="white-space: nowrap;padding-top:20px">
                                                <asp:TextBox runat="server" ID="tbx_apoyo" CssClass="tbxreg" Width="80%"></asp:TextBox>
                                        ...
                                        <tr><td colspan="2" style="text-align: center;padding-top:20px">
                                             <table style="margin: auto;"><tr><td id="reg">
                                             <asp:Button ID="cmd_apoyo" runat="server" CssClass="botones" Text="Aceptar" style="font-size: 100%;" ValidationGroup="apoyo" />
                                             </td><td id="reg">
                    ...
                    <asp:View runat="server" ID="v_dieciseis">
                       <table class="popupmsg">
                            <tr><td id="reg" style="padding-top:20px">Sobre las actividades deportivas y/o socioculturales</td></tr>
                            <tr><td id="reg">
                                <asp:Panel runat="server" ID="p_deportes" DefaultButton="cmd_deportes">
                                    <table style="width: 100%">
                                        <tr><td id="reg" style="white-space: nowrap;padding-top:20px">¿Qué deporte o actividad sociocultural practicas o te gustaría practicar?</td>                                        
                                        </tr>
                                        <tr><td id="reg" style="white-space: nowrap;padding-top:20px">
                                            <asp:DropDownList runat="server" ID="ddl_deportes" CssClass="ddlreg_cien" AutoPostBack="true" ValidationGroup="deportes" Width="300px"></asp:DropDownList>
                                        ...
                                        <tr>
                                            <td id="reg" style="white-space: nowrap;padding-top:20px">
                                                <asp:TextBox runat="server" ID="txt_deportes" CssClass="tbxreg"></asp:TextBox>
                                        ...
                                        <tr><td colspan="2" style="text-align: center;padding-top:20px">
                                             <table style="margin: auto;"><tr><td id="reg">
                                             <asp:Button ID="cmd_deportes" runat="server" CssClass="botones" Text="Aceptar" style="font-size: 100%;" ValidationGroup="deportes" />
                                             </td><td id="reg">
                    ...
                    <asp:View runat="server" ID="v_diecisiete">
                       <table class="popupmsg">
                            <tr><td id="reg" style="height:100px;">
                                Por favor seleccione una o mas razones por las que te inscribiste en la UTJ y los medios por los que te enteraste de la universidad.</td></tr>
                        </table>
                    </asp:View>
                ...
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="ddl_apoyo" EventName="SelectedIndexChanged" />
                        ...
                        <asp:Panel ID="p_registrok" runat="server" style="display: none;" DefaultButton="cmd_descarga">
                            <table><tr><td style="text-align: right; padding: 5px;"><input onclick="javascript: window.close();" type="image" src="../img/close_coe.png"/></td></tr><tr><td>
                               <table class="popupmsg" style="width: 100%"><tr><td style="width: 100%;">
                                   <asp:linkbutton ID="lb_closeok" runat="server"></asp:linkbutton>
                                   <strong><span style="font-size: 2em;">¡Hemos terminado!</span></strong><br />
                                   <br />
                                   Guarda en un lugar seguro el <strong>número de tu registro</strong> y el dia seleccionado&nbsp;para tu <strong>entrevista en la UTJ</strong>.<br />
                                   <br />
                                   Imprime y guarda tu comprobante de registro con el botón &quot;Descargar&quot;, además para tu comodidad y seguridad te lo hemos enviado a tu correo.<br />
                               <strong>Revísalo con atención: contiene información detallada del siguiente paso en tu ingreso.</strong></td></tr><tr>
                               <td id="pad" style="width: 100%;">
                                  <table style="margin: auto;"><tr><td id="pad" style="font-size: 1.5em;">
                                    Numero de registro:</td><td><asp:label ID="lbl_ndreg" runat="server"></asp:label></td></tr>
                                      <tr><td id="pad" style="font-size: 1.5em;">Día y hora de entrevista:</td><td><asp:label ID="lbl_fyhe" runat="server"></asp:label></td></tr>
                                  </table>
                               </td></tr>
                                   <tr>
                                       <td id="pad" style="padding: 10px; width: 100%;">
                                           <asp:Button ID="cmd_descarga" runat="server" CausesValidation="False" CssClass="botones" style="font-size: 100%;" Text="Descargar" />
                                       </td>
                                   </tr>
                                </table>
                             </td></tr></table>
...
'    CssClass="customCalloutStyle" WarningIconImageUrl="../img/alert_yel.png" Enabled="True"></asp:ValidatorCalloutExtender>%>
    ...
    <%-- <asp:RangeValidator ID="rv_calendario" runat="server" ErrorMessage="¡Por favor elije el día y hora de tu cita!." 
        Display="None" ControlToValidate="cal_48" SetFocusOnError="True" ValidationGroup="reg" MinimumValue="01/01/2016" MaximumValue="01/01/2017"></asp:RangeValidator>
    <asp:ValidatorCalloutExtender ID="vcoe_rv_calendario" runat="server" TargetControlID="rv_calendario" CloseImageUrl="../img/close_coe.png" 
        CssClass="customCalloutStyle" WarningIconImageUrl="../img/alert_yel.png" Enabled="True"></asp:ValidatorCalloutExtender>--%>
...
<%'----------------------CODIGO DEL LOADING----------------------------- %>
<%--         <asp:UpdatePanelAnimationExtender ID="upae_carreras" runat="server" 
                 Enabled="True" TargetControlID="up_carreras">
                       <Animations>
                            <OnUpdating>
                                  <Parallel duration="0.5" fps="30">
                                  <FadeOut AnimationTarget="up_carreras" minimumOpacity="0" ForceLayoutInIE="true"/>
                                  </Parallel>
                           </OnUpdating>
                           <OnUpdated>
                                <Parallel duration="0.5" fps="30">
                                  <FadeIn Animationtarget="up_carreras" minimumOpacity="0" ForceLayoutInIE="true"/>
                                  </Parallel>
                             </OnUpdated>
                   </Animations>
            </asp:UpdatePanelAnimationExtender> 
  
            <asp2:ModalUpdateProgress ID="mup_ping" runat="server" AssociatedUpdatePanelID = "up_carreras"
                      BackgroundCssClass="background_blanco" CancelControlID="lb_cancel" 
                      DisplayAfter="100"><ProgressTemplate>
                      <div class="centrado_modal">
                          ...
                          <asp:LinkButton ID="lb_cancel" runat="server"></asp:LinkButton>
                      </div>
                      </ProgressTemplate>
          </asp2:ModalUpdateProgress>--%>
<%'----------------------END----------------------------- %>
