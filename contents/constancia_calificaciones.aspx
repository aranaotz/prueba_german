<%@ Page Title="" Language="VB" MasterPageFile="~/logins/logins.master" AutoEventWireup="false" CodeFile="constancia_calificaciones.aspx.vb" Inherits="contents_constancia_calificaciones" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cph_content" Runat="Server">
    
            <asp:MultiView runat="server" ID="mv_contastancia_calificaciones">

                <asp:View runat="server" ID="v_cero">

                             <table class="centrado"><tr><td class="titulocategoria" style="text-align: center; padding: 20px 0px 20px 0px;" colspan="3">Constancia con calificaciones</td></tr><tr><td>
