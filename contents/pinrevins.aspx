<%@ Page Title="" Language="VB" MasterPageFile="../logins/logins.master" AutoEventWireup="false" CodeFile="pinrevins.aspx.vb" Inherits="contents_pinrevins" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<%@ Register assembly="AjaxControls" namespace="AjaxControls" tagprefix="asp2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cph_content" Runat="Server">
    <asp:UpdatePanel runat="server" ID="up_pinrevis" UpdateMode="Conditional">
        <ContentTemplate>
                         ...
                         <div class="topbar"><table><tr><td><asp:ImageButton ID="ib_regresar" runat="server" ImageUrl="~/img/arrowback.png" OnClick="ib_regresar_Click" /></td><td style="padding: 0px 10px 0px 10px; font-size: 2em; color: #fff; vertical-align: top;">|</td>
                            ...
                            <table class="centrado"><tr><td class="titulocategoria" style="text-align: center; padding: 20px 0px 20px 0px;" colspan="3">Revisión de registro</td></tr><tr><td>
                                ...
                                <tr><td style="text-align: center; padding: 20px 0px 20px 0px;" colspan="3">
                                    <asp:HiddenField runat="server" ID="hf_c" />
                                        ...
                                        <Columns>
                                            <asp:TemplateField><ItemTemplate>
                                                <div id="gv_result" style="text-align:left;"><table><tr><td><asp:LinkButton ID="lb_gvresultado" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "item")%>'
                                                    ...
                                                    <td style="padding: 7px 0px 0px 5px;"><asp:imageButton ID="ib_delete" runat="server" ImageUrl="../img/close_coer.png" OnClick="ib_delete_Click" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "id")%>' /> </td></tr></table></div>
                            ...
                            <asp:HiddenField runat="server" ID="hf_elimina" />
                             <asp:ModalPopupExtender ID="mod_elimina" runat="server" DynamicServicePath="" Enabled="True" TargetControlID="hf_elimina" PopupControlID="p_advertencia" BackgroundCssClass="modalBackground_gris" CancelControlID="ib_close1">
                             </asp:ModalPopupExtender>
                            <asp:Panel ID="p_advertencia" runat="server" style="display:none; width:100%; padding-left:60%;" >
                                    <table style="width: 40%;"><tr><td style="text-align: right; padding: 7px;"><asp:ImageButton ID="ib_close1" runat="server" ImageUrl="~/img/close_coe.png" /></td></tr><tr><td>
                                         <table style="background:#FFF; width:100%; border-radius: 5px;">
                                             ...
                                             <tr>
                                               ...
                                               <tr>
                                                <td colspan="2" style="text-align: center; padding: 10px 5px 10px 5px;">
                                                    <asp:Label runat="server" ID="lb_otraadvertencia" style="text-align:center" Text="¿Seguro que deseas continuar?"></asp:Label><br />
                                                   <strong> <asp:Label ID="lbl_advertencia" runat="server" Text=" El aspirante se eliminará permanentemente!" style="text-align:center"></asp:Label></strong>
                                                </td>
                                            </tr>
                                         <tr>
        ...
        <div class="topbar"><table><tr><td><asp:ImageButton ID="ib_back" runat="server" ImageUrl="~/img/arrowback.png" /></td><td style="padding: 0px 10px 0px 10px; font-size: 2em; color: #fff; vertical-align: top;">|</td>
            ...
            <td style="font-size: 1.5em;"><asp:Linkbutton runat="server" ID="lb_ficha" Text="Ficha de aspirante" CssClass="boton_texto_dentro"/></td>
            <td style="padding: 0px 10px 0px 10px; font-size: 2em; color: #fff; vertical-align: top;">|</td>
            <td style="font-size: 1.5em;"><asp:Linkbutton runat="server" ID="lb_carta" Text="Carta responsiva" CssClass="boton_texto_dentro"/></td>
            <td style="padding: 0px 10px 0px 10px; font-size: 2em; color: #fff; vertical-align: top;">|</td>
            <td style="font-size: 1.5em;"><asp:Linkbutton runat="server" ID="lb_comprobante" Text="Comprobante de registro" CssClass="boton_texto_dentro"/></td>
            <td style="padding: 0px 10px 0px 10px; font-size: 2em; color: #fff; vertical-align: top;">|</td>
            <td style="font-size: 1.5em;"><asp:Linkbutton runat="server" ID="lb_sendmail" Text="Enviar Comprobante de Registro" CssClass="boton_texto_dentro"/>
                <asp:ConfirmButtonExtender ID="cbe_sendmail" runat="server" ConfirmText="Se adjuntará al correo el nuevo comprobante de registro. ¿Desea continuar?" TargetControlID="lb_sendmail"/>
            </td>
        </tr></table></div>
           <%--<div ID="sinfoto">
               <asp:ModalPopupExtender ID="mod_sin_foto" runat="server" DynamicServicePath="" Enabled="True" TargetControlID="lb_ficha" PopupControlID="p_sin_foto" BackgroundCssClass="modalBackground_gris" CancelControlID="ib_close1">
                             </asp:ModalPopupExtender>
                            <asp:Panel ID="p_sin_foto" runat="server" style="display:none; width:100%; padding-left:60%;" >
                                    <table style="width: 40%;"><tr><td style="text-align: right; padding: 7px;"><asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/img/close_coe.png" /></td></tr><tr><td>
                                         <table style="background:#FFF; width:100%; border-radius: 5px;">
  
                                             <tr>
                                                <td colspan="2" style="text-align: center; padding: 10px 5px 10px 5px;">
                                                    <asp:Image ID="Image1" runat="server" ImageUrl="~/img/alert.png" ImageAlign="AbsMiddle" />
                                                </td>
                                            </tr>
                                               <tr>
                                                <td colspan="2" style="text-align: center; padding: 10px 5px 10px 5px;">
                                                    <%--<asp:Label runat="server" ID="Label1" style="text-align:center" Text="¿Seguro que deseas continuar?"></asp:Label><br />
                                                   <strong> <asp:Label ID="Label2" runat="server" Text="Debes tomar la fotografía del aspirante!" style="text-align:center"></asp:Label></strong>
                                                </td>
                                            </tr>
                                         <tr>
                                             <td colspan="2" style="text-align: center; padding: 10px 5px 10px 5px;"><pre><asp:Button ID="Button1" runat="server" Text="Continuar" CssClass="botones" Font-Size="Large" OnClick="btn_continuar_Click" />     <asp:Button ID="Button2" runat="server" Text="Cancelar" CssClass="botones" Font-Size="Large" /></pre></td>
        ...
        <tr><td><table><tr><td><asp:Image ID="img_user" runat="server" ImageUrl="../img/egg.png" style="width: 150px;"/></td><td style="vertical-align: bottom; text-align: left;">
            <table><tr><td>Para actualizar la fotografía del aspirante elija una imagen de su computadora.</td></tr><tr><td>
                <asp:FileUpload ID="fu_photo" runat="server" />
                                                                                                                        </td></tr>
                <tr>
                    <%--<td><CuteWebUI:Uploader id="Uploader1" runat="server" /></td>--%>
                </tr>
               <%-- <tr>
                    <td>
        ...
        <table class="tablacien" style="text-align: left;"><tr><td class="titulocelda">Nombres</td><td class="titulocelda">Primer Apeliido</td><td class="titulocelda">Segundo Apellido</td><td class="titulocelda">Sexo</td><td class="titulocelda">Tipo de Sangre</td><td class="titulocelda">Estado Civil</td>
        ...
        <tr><td><table class="tablacien" style="width: 100%; text-align: left;"><tr><td class="titulocelda">Dirección actual: Calle y número</td><td class="titulocelda">Código postal</td><td class="titulocelda"></td>
         ...
         <tr><td>
             <table class="tablacien" style="text-align: left;"><tr>
                 ...
                 <td class="celdascien" style="width: 16%"><asp:TextBox ID="tbx_20" runat="server" CssClass="tbxreg_min"></asp:TextBox></td>
        ...
        <tr><td class="titulocelda">El siguiente paso para tu registro es tu entrevista en la UTJ.<br />
                       Elije un día de los marcados en verde y espera un momento a que aparezcan las horas disponibles para la cita; selecciona una y haz click en guardar registro.</td></tr>
        <tr><td>
            ...
            <asp:ValidatorCalloutExtender ID="vcoe_rfv_fecha" runat="server" TargetControlID="rfv_fecha" CloseImageUrl="../img/close_coe.png" 
                ...
                <tr><td style="font-size: 1.0em; border-radius: 4px;" class="calendarWrapper">
            ...
            </asp:calendar><asp:HiddenField ID="hf_cs" runat="server" /></td>
        ...
        <tr><td>
            ...
            <asp:ModalPopupExtender ID="hf_popupok_mpe" runat="server" DynamicServicePath="" Enabled="True" TargetControlID="hf_popupok" PopupControlID="p_registrok" BackgroundCssClass="modalBackground_gris" CancelControlID="ib_closem">
            </asp:ModalPopupExtender>
        </td></tr>
        <tr><td>
                ...
                <asp:MultiView ID="mv_msgs" runat="server">
                  ...
                  <asp:View ID="v_bachillerato" runat="server">
                            ...
                            <tr><td id="pad">
                                <asp:Panel runat="server" ID="p_becas" DefaultButton="cmd_becas">
                                    <table style="width: 100%">
                                        ...
                                        <tr>
                                             <td id="pad" style="white-space: nowrap;padding-top:20px">
                       ...
                       <table class="popupmsg">
                            ...
                            <tr><td id="pad">
                                <asp:Panel runat="server" ID="p_apoyo" DefaultButton="cmd_apoyo">
                                    <table style="width: 100%">
                                        <tr><td id="pad" style="white-space: nowrap;padding-top:20px">¿Por qué motivo?</td>                                           
                                        </tr>
                                        <tr><td id="pad" style="white-space: nowrap;padding-top:20px">
                                        ...
                                        <tr>
                                             <td id="pad" style="white-space:normal;padding-top:20px">
                    ...
                    <asp:View runat="server" ID="v_dieciseis">
                       <table class="popupmsg">
                            <tr><td id="pad" style="padding-top:20px">Sobre las actividades deportivas y/o socioculturales</td></tr>
                            <tr><td id="pad">
                                <asp:Panel runat="server" ID="p_deportes" DefaultButton="cmd_deportes">
                                    <table style="width: 100%">
                                        <tr><td id="pad" style="white-space: nowrap;padding-top:20px">¿Qué deporte o actividad sociocultural practicas o te gustaría practicar?</td>                                        
                                        </tr>
                                        <tr><td id="pad" style="white-space: nowrap;padding-top:20px">
                    ...
                    <asp:AsyncPostBackTrigger ControlID="ddl_apoyo" EventName="SelectedIndexChanged" />
                        ...
                        <asp:Panel ID="p_registrok" runat="server" style="display: none" DefaultButton="cmd_ok">
                            <table><tr><td style="text-align: right; padding: 5px;"><asp:ImageButton ID="ib_closem" runat="server" ImageUrl="../img/close_coe.png" /></td></tr><tr><td>
                               <table class="popupmsg" style="width: 100%; text-align:center;"><tr><td></td><td style="width: 100%; padding: 10px 0px 5px 0px;"><img alt="Correcto" src="..\img\ok_green.png"/></td>
                               <td>
                        ...
                        <table class="tablacien"><tr>
                            <td>
                                <table class="tablacien">
                                    <tr><td class="titulo_medio" style="padding: 5px 5px 15px 5px;">Revisión de inscripción</td></tr>
